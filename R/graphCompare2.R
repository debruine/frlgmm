...
graphCompare2 <- function(data, axis1 = 1, axis2 = 2, gp = c(), 
  ...
  PCA <- plotTangentSpace(coords, axis1 = axis1, axis2 = axis2, verbose = T, warpgrids = FALSE)
  ...
  plotRefToTarget(mean.shape, PCA$pc.shapes[[1]], method = method)
  plotRefToTarget(mean.shape, PCA$pc.shapes[[2]], method = method)
  plotRefToTarget(mean.shape, PCA$pc.shapes[[3]], method = method)
  plotRefToTarget(mean.shape, PCA$pc.shapes[[4]], method = method)
